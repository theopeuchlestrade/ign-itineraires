...
- Date:
- Tester:
- Successful Géoplateforme contracts at:
...
- [ ] `README.md`, `CHANGELOG.md`, `PRIVACY.md`, `THIRD_PARTY_NOTICES.md`, test
      plan, and release checklist are current
...
- [ ] Local Markdown links and publication metadata checks pass
